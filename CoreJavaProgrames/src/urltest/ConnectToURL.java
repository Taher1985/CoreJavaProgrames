...
public class ConnectToURL {
	 ...
	 private static final String POST_CONTENT_TYPE = "application/x-www-form-urlencoded";
	    private static final String LOGIN_USER_NAME_PARAMETER_NAME = "userId";
	    private static final String LOGIN_PASSWORD_PARAMETER_NAME = "userPassword";
 
	    private static final String LOGIN_USER_NAME = "tali20";
	    private static final String LOGIN_PASSWORD = "Welcome";
 
	    private static final String TARGET_URL = "https://pmlprdwma.pano-dxc.com/wma/login.jsf";
 
	public static void main(String[] args)
	{
        System.out.println("Running the program...\n");
        ConnectToURL httpUrlBasicAuthentication = new ConnectToURL();
